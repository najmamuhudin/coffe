  ...
  return (
    <div className="bg-white dark:bg-[#2c1810] border border-gray-100 dark:border-gray-800 rounded-2xl overflow-hidden group hover:shadow-xl transition-all duration-300 hover:-translate-y-1 relative">
      ...
      <button
        ...
        aria-label="Wishlist"
      >
        <svg width="13" height="13" viewBox="0 0 24 24" fill={wishlist ? "#8B5E3C" : "none"} stroke="#8B5E3C" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <div className="p-4">
        ...
        <div className="flex items-center justify-between mt-3 gap-2">
          <button
            ...
            className={`flex-1 text-[11px] font-bold flex items-center justify-center gap-1.5 px-3 py-2 rounded-full border transition-all duration-200 ${added
